...
import { ShoppingCart, User, Search, Menu, Globe, LogOut, ArrowLeft } from 'lucide-react';
...
const StorefrontLayout = () => {
  ...
  const isDistractionFree = location.pathname.includes('/checkout');
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4">
                {!isDistractionFree && currentUser && <NotificationBell />}
                ...
                {isDistractionFree && (
                  <LocalizedLink to="/cart" className="flex items-center gap-2 text-on_surface_variant hover:text-primary font-bold text-sm transition-all group">
                    <ArrowLeft size={18} className="group-hover:-translate-x-1 transition-transform" />
                    <span>{t('cart.back_to_cart', 'Quay lại giỏ hàng')}</span>
                  </LocalizedLink>
                )}

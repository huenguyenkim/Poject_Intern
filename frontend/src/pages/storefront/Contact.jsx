      ...
      <div className="bg-surface_container_lowest min-h-screen">
        ...
        <div className="bg-primary pt-24 pb-32 px-6">
          <div className="max-w-[1280px] mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-black text-on_primary mb-6 tracking-tight uppercase">
              {t('contact.title', 'Contact Us')} 🍬
            </h1>
            <p className="text-on_primary/80 text-xl font-bold max-w-2xl mx-auto uppercase">
              {t('contact.subtitle', "Have a question about our sweets? We'd love to hear from you! Whether it's a Bulk order or just a sweet hello.")}
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-8">
              <div className="bg-surface_container_high rounded-[40px] p-10 flex flex-col gap-10">
                <h2 className="text-3xl font-black text-on_surface uppercase tracking-tight">{t('contact.visit_us', 'Visit Our Store')}</h2>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-on_surface mb-1 uppercase tracking-tight">{t('contact.location', 'Our Location')}</h3>
                      <p className="text-on_surface_variant font-medium leading-relaxed font-bold">
                        {t('contact.address', '123 Sweet Street, Sugar Land\nCandy Kingdom, CK 88888')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-on_surface mb-1 uppercase tracking-tight">{t('contact.call_us', 'Call Us')}</h3>
                      <p className="text-on_surface_variant font-medium leading-relaxed font-bold">
                        +1 (555) 123-4567<br />
                        {t('contact.hours', 'Mon - Sat: 9am - 8pm')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-on_surface mb-1 uppercase tracking-tight">{t('contact.email_us', 'Email Us')}</h3>
                      <p className="text-on_surface_variant font-medium leading-relaxed font-bold">
              ...
              {/* Fun Fact Card */}
              <div className="bg-secondary p-8 rounded-[40px] text-on_secondary relative overflow-hidden group">
                 <div className="relative z-10 transition-transform duration-500 group-hover:scale-105">
                    <h3 className="text-2xl font-black mb-3 italic uppercase">{t('contact.fun_fact', 'Did you know?')}</h3>
                    <p className="font-bold opacity-90 leading-relaxed">
                      {t('contact.gummi_fact', 'Gummi bears were first created in Germany in 1922 by Hans Riegel! 🍭')}
                    </p>
                 </div>
